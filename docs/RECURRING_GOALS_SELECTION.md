...
**Selected 303 · conditional 16 · excluded 324**
...
| Code/React_NextJS_Development | 70 | 0 | 0 | 70 |
| Code/Swift_Development | 133 | 0 | 0 | 133 |
| Code/Testing_and_Coverage | 10 | 5 | 0 | 5 |
| Code/Universal | 18 | 18 | 0 | 0 |
| Deployment | 19 | 1 | 13 | 5 |
| Design/Data_Visualization | 6 | 6 | 0 | 0 |
| Design/Design_Fidelity | 8 | 1 | 0 | 7 |
...
| Project_Structure | 7 | 6 | 0 | 1 |
| Security_and_Secrets | 5 | 4 | 0 | 1 |
| UX | 95 | 95 | 0 | 0 |
...
| Code/React_NextJS_Development | `**/*.{ts,tsx,js,jsx}` | 70 | the glob matches this repo's .js files, but every rule on the React/Next sheet presumes a React component tree, which this repo does not have |
| Code/Python_Development | `**/*.py` | 61 | no Python source in this repo |
| Design/Design_Fidelity | `projects with a Claude Design handoff bundle` | 7 | no design/claude-design bundle; the design phase here uses frontend-design and design-reference |
...
| Deployment | `server/**` | 2 | no server/ directory; lib/server.js is a local HTTP surface, not a deployed service tree |
...
| Code/Testing_and_Coverage | `**/*UITests*/**, **/e2e/**` | 1 | no XCUITest or e2e directory; Playwright drives run from test/ instead |
...
| Project_Structure | `new projects` | 1 | Interstice is an existing project |
| Security_and_Secrets | `server/**, app/**` | 1 | neither directory exists |
...
- **Code/Testing_and_Coverage** (5): TC-006, TC-007, TC-008, TC-009, TC-010
...
- **Deployment** (14): DEP-001, DEP-002, DEP-003, DEP-006, DEP-007, DEP-008, DEP-010, DEP-011, DEP-013, DEP-014, DEP-015, DEP-016, DEP-017, DEP-018
- **Design/Data_Visualization** (6): DV-001, DV-002, DV-003, DV-004, DV-005, DV-006
- **Design/Design_Fidelity** (1): DF-008
...
- **Project_Structure** (6): PS-001, PS-003, PS-004, PS-005, PS-006, PS-007
- **Security_and_Secrets** (4): SEC-001, SEC-002, SEC-003, SEC-004
