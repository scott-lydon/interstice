...
// (`focus.blockMinutes`, whose shipped value lives only in the config). A break (a blacklisted
// app frontmost, display sleep or screen lock, or
...
//
// `createMachine` and `localDay` are the whole public surface. The reducer underneath it, `reduce(state, event) ->
