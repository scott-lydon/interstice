...
//
// Why it can run continuously rather than waiting for a rung to be on screen: it is settled that a
 ...
 *
 * A star belongs to the local calendar day the block completed on, and `localDay`
