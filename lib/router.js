 ...
 *
 * The order here is the fallback, not the policy: `config.ladder` is what actually
 * runs, and `validate` checks it against this list so a typo in the config is a
 * startup error rather than a rung that silently never fires.
 */
